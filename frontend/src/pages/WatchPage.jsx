...
import WatchPageSkeletion from "../components/skeletons/WatchPageSkeletion"
      ...
      <div className="mx-auto container px-4 py-8 h-full">
        ...
        {similarContent.length > 0 && (
            <div className="mt-12 max-w-5xl mx-auto relative">
                <h3 className="text-3xl font-bold md--4">
                    Similar Movies/TV show
                </h3>

                <div className="flex overflow-x-scroll scrollbar-hide gap-4 group" ref={sliderRef}>
