  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold md:text-6xl">Unlimited movies, TV shows and more</h1>
        ...
        <form className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
          ...
          />
          <button type="submit" className="bg-red-600 text-xl lg:text-2xl lg:px-6 py-1 md:py-2 rounded flex justify-center items-center ">
            Get Started
       ...
       <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 relative">
            <img src="/tv.png" alt="Tv images" className="mt-4 z-20 relative" />
            <video 
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
          ...
          <div className="flex-1 relative overflow-hidden">
            <img src="/device-pile.png" alt="Device images" className="mt-4 z-20 relative" />
            <video 
